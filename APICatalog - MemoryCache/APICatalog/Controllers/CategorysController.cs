...
namespace APICatalog.Controllers
{
    ...
    public class CategorysController : ControllerBase
    {
        ...
        public CategorysController(IUnitOfWork unitOfWork , IMyService myService, IConfiguration configuration, ILogger<CategorysController> logger, IMemoryCache cache)
        {
        ...
        public async Task<ActionResult<IEnumerable<CategoryDTO>>> Get()
        {
            if (!_cache.TryGetValue(CacheCategoriesKey, out IEnumerable<Category>? categories))
            {
                ...
                if (categories is  null || !categories.Any()){
                    ...
                    _logger.LogWarning("There are not categories");
                    return NotFound("There are not categories");
                }
        ...
        public async Task<ActionResult<CategoryDTO>> Get(int id)
        {
            ...
            {
                category = await _unitOfWork.CategoryRepository.GetByIdAsync(c => c.CategoryId == id);
                if (category is null)
                {
        ...
        public async Task<ActionResult<CategoryDTO>> Post(CategoryDTO categoryDto)
        {
            ...
            RemoveCacheAfterChange(createCategory.CategoryId);
        ...
        public async Task<ActionResult<CategoryDTO>> Put(int id, CategoryDTO categoryDto)
        {
            ...
            RemoveCacheAfterChange(id, updatedCategory);
        ...
        private void RemoveCacheAfterChange(int id, Category? categoria = null)
        {
            ...
            if (categoria != null)
            {
                SetCache(GetCategoryCacheKey(id), categoria);
            }
        }
